...
// global constants                                                                                                                   
const int DEALER_STAY = 17; // value at which the dealer should no longer hit 
...
public:
 ...
 private:
    ...
    Deck m_deck;                // the deck for the game
    vector<Player> m_players;   // a list of all players in the game (minus the dealer)

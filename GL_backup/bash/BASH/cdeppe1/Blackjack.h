...
class Blackjack {
  ...
  private:
    ...
    /****************************************************************
     * Name: ResetPlayer
     * Preconditions: player - a reference to the player
     * Postconditions:
     *   Sets the player's busted status to false and clears their hands
     ****************************************************************/
    ...
    //m_playCount - a static int used int SettlePlayerBet

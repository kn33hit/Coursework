...
cond:
	...
	;; ---------------------------------------------
	;; i would've attempted more bit manipulation to the product
	;; variable but I'm running out of time
	;; plus I think I'm missing the initial add in the beginning
	;; i'm following the implementation provided in the link
	;;  where there are four different conditionals according to
	;; last two bits to decide whether to add or not and then shift
